    ...
    <footer className="bg-[#e69f42] dark:bg-[#e69f42] text-white">
            <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" className="flex items-center">
                            <Image src={logo} className=" w-60 h-60 me-3" alt="FlowBite Logo" />
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-black sm:text-center dark:text-black font-bold">© 2024 <a href="https://flowbite.com/" className="hover:underline">KRE Elite Sport™</a>. All Rights Reserved.</span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <Link href="#" className="text-black hover:text-gray-900 dark:hover:text-white ms-5">
