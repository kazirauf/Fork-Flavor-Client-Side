...
const OurWebsiteFacilities = () => {
    return (
        <div className="mt-20">
           <h1 className="text-center text-4xl font-bold">Our <span className="text-[#e69f42]">Featured</span> </h1>
  ...
  <div className="card-body">
    ...
    <p>Easily upload your favorite recipes and explore a rich collection of dishes from home cooks, culinary students, and cooking enthusiasts. Whether you're looking for a quick meal or a gourmet dish, there is something for everyone.</p>
  ...
  <div className="card-body">
    ...
    <p>Enhance your cooking experience with built-in tools like interactive ingredient checklists and customizable cooking timers, designed to keep your kitchen tasks organized and hassle-free.</p>
    <div className="card-actions justify-end">
  ...
  <div className="card-body">
    ...
    <p>Connect with a vibrant community by commenting on recipes, leaving ratings, upvoting the best dishes, and following other cooks. Stay inspired and share your culinary journey with fellow food lovers.</p>
    <div className="card-actions justify-end">
